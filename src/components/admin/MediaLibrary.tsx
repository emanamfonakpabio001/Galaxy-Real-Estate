            ...
            {mediaList.map((media) => (
              ...
              >
                ...
                <div className="relative h-36 bg-slate-900 overflow-hidden flex items-center justify-center">
                  ...
                  {/* Mobile Quick Action Buttons on Image (touch friendly) */}
                  ...
                  <div className="hidden md:flex absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity items-center justify-center gap-1.5 p-2 z-10">
                    {/* Image Editor */}
                    <button
                      type="button"
                      onClick={() => openEditorFor(media)}
                ...
                {/* Footer Metadata & Mobile Action Buttons */}
                <div className="p-2.5 flex-1 flex flex-col justify-between text-[10px] gap-2">
                  <div>
                  ...
                  {/* Mobile Action Row (Visible on touch devices) */}
                  <div className="md:hidden flex items-center gap-1.5 pt-2 border-t border-slate-100">
                    <button
                      type="button"
                      onClick={() => openEditorFor(media)}
                      className="flex-1 py-1.5 px-2 bg-amber-50 active:bg-amber-100 text-amber-900 border border-amber-200 rounded-lg text-[10px] font-bold flex items-center justify-center gap-1 transition"
                    ...
                    <button
                      type="button"
                      onClick={() => handleCopyUrl(media.url, media.fileId)}
                      className="p-1.5 bg-slate-100 active:bg-slate-200 text-slate-700 rounded-lg text-[10px] font-bold flex items-center justify-center transition"
                      title="Copy URL"
                    >
                      {copiedId === media.fileId ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Copy className="w-3.5 h-3.5" />}
                    </button>

                    <button
                      type="button"
                      onClick={() => openMetaEdit(media)}
                      className="p-1.5 bg-blue-50 active:bg-blue-100 text-blue-700 border border-blue-200 rounded-lg text-[10px] font-bold flex items-center justify-center transition"
                      title="Edit details"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => handleDelete(media.fileId)}
                      className="p-1.5 bg-red-50 active:bg-red-100 text-red-700 border border-red-200 rounded-lg text-[10px] font-bold flex items-center justify-center transition"
                      title="Delete"
                    >
